...
urlpatterns = patterns('',
    ...
    (r'^scenic/apps/station/sodxtrmts/$', 'scenic.views.sodxtrmts'),
    (r'^scenic/apps/station/sodxtrmts/(?P<stn_id>[^,]+)(\&P<start_date>[\d{4}])(\&P<end_date>[\d{4})(\&P<element>[^,]+)$', 'scenic.views.sodxtrmts'),
    (r'^scenic/apps/station/sodxtrmts/visualize/$', 'scenic.views.sodxtrmts_visualize'),
