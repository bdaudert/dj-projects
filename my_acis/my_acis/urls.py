...
urlpatterns = patterns('',
    ...
    (r'^sw_ckn/data/gridded/(?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<bounding_box>[^,]+)(\&P<summary>[^,]+)$', 'my_data.views.data_gridded'),
    (r'^sw_ckn/data/gridded/(?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<state>[^,]+)(\&P<summary>[^,]+)$', 'my_data.views.data_gridded'),
    (r'^sw_ckn/data/gridded/(\?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<loc>[^,]+)(\&P<summary>[^,]+)$', 'my_data.views.data_gridded'),
