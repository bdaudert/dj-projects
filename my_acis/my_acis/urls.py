...
urlpatterns = patterns('',
    ...
    (r'^sw_ckn/data/historic/(?P<stn_id>\d+)(\&P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)$', 'my_data.views.data_historic'),
    ...
    (r'^sw_ckn/apps/clim_sum_maps/(?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<element>[^,]+)(\&P<grid>[^,]+)(\&P<state>[^,]+)$', 'my_data.views.clim_sum_maps'),
    (r'^sw_ckn/apps/clim_sum_maps/(\?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<element>[^,]+)(\&P<grid>[^,]+)(\&P<bounding_box>[^,]+)$', 'my_data.views.clim_sum_maps'),
