...
urlpatterns = patterns('',
    ...
    (r'^sw_ckn/data/modeled/(?P<start_date>[\d{8}|por])(\&P<end_date>[\d{8}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<bounding_box>[^,]+)$', 'my_data.views.data_modeled'),
    (r'^sw_ckn/data/modeled/(?P<start_date>[\d{8}|por])(\&P<end_date>[\d{8}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<state>[^,]+)$', 'my_data.views.data_modeled'),
    (r'^sw_ckn/data/modeled/(\?P<start_date>[\d{8}|por])(\&P<end_date>[\d{8}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<loc>[^,]+)$', 'my_data.views.data_modeled'),
