...
urlpatterns = patterns('',
    ...
    (r'^sw_ckn/$', 'my_data.views.home_view'),
    (r'^sw_ckn/start/$', 'my_data.views.front_page_dash'),
    ...
    (r'^sw_ckn/finder/$', 'my_data.views.finder'),
    ...
    (r'^sw_ckn/data/historic/(?P<stn_id>\d{6})(\&P<start_date>[\d{8}|por])(\&P<end_date>[\d{8}|por)(\&P<elements>[^,]+)$', 'my_data.views.data_historic'),
    (r'^sw_ckn/data/modeled/$', 'my_data.views.data_modeled'),
    (r'^sw_ckn/data/modeled/(?P<grid_selection>[state|bbox])(\&P<start_date>[\d{8}|por])(\&P<end_date>[\d{8}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<bounding_box>[^,]+)$', 'my_data.views.data_modeled'),
    (r'^sw_ckn/data/modeled/(?P<grid_selection>[state|bbox])(\&P<start_date>[\d{8}|por])(\&P<end_date>[\d{8}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<state>[^,]+)$', 'my_data.views.data_modeled'),
    (r'^sw_ckn/apps/$', 'my_data.views.apps_home'),
    (r'^sw_ckn/apps/climate/$', 'my_data.views.apps_climate'),
    (r'^sw_ckn/apps/climate/(?P<stn_id>\d+)/$', 'my_data.views.apps_climate'),
    (r'^sw_ckn/apps/climate/metagraph/$', 'my_data.views.metagraph'),
    (r'^sw_ckn/apps/climate/monthly_aves/$', 'my_data.views.monthly_aves'),
    (r'^sw_ckn/apps/climate/grid_point_time_series/$', 'my_data.views.grid_point_time_series'),
    (r'^sw_ckn/apps/climate/grid_point_time_series/(?P<lat>\-?(0|1-9+)\.?\d+)(\&P<lon>\-?(0|1-9+)\.?\d+)$', 'my_data.views.grid_point_time_series'),
    (r'^sw_ckn/apps/climate/clim_sum_maps/$', 'my_data.views.clim_sum_maps'),
