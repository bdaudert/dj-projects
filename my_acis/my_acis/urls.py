...
urlpatterns = patterns('',
    ...
    (r'^sw_ckn/apps/$', 'my_data.views.apps_climate'),
    (r'^sw_ckn/apps/(?P<stn_id>\d+)/$', 'my_data.views.apps_climate'),
    (r'^sw_ckn/apps/sw_ckn_station_apps/$', 'my_data.views.sw_ckn_station_apps'),
    (r'^sw_ckn/apps/sw_ckn_station_apps/(?P<stn_id>\d{6})(\&P<start_date>[\d{8}|por])(\&P<end_date>[\d{8}|por)(\&P<elements>[^,]+)$', 'my_data.views.sw_ckn_station_apps'),
