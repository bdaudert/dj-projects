...
urlpatterns = patterns('',
    ...
    (r'^scenic/apps/gridded/grid_sodxtrmts/$', 'scenic.views.sodxtrmts',{'app_type':'grid'}),
    (r'^scenic/apps/gridded/grid_sodxtrmts/(?P<lat>\-?(0|1-9+)\.?\d+)(\&P<lon>\-?(0|1-9+)\.?\d+)(\&P<start_date>[\d{4}])(\&P<end_date>[\d{4})(\&P<element>[^,]+)$', 'scenic.views.sodxtrmts',{'app_type':'grid'}),
