...
urlpatterns = patterns('',
    ...
    (r'^swcke/download/$', 'my_data.views.download'),
    (r'^swcke/feedback/$', 'my_data.views.feedback'),
    ...
    (r'^swcke/apps/station/(?P<stn_id>\d+)(\&P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)$', 'my_data.views.swcke_station_apps'),
    ...
    (r'^swcke/apps/station/sodxtrmts/visualize/$', 'my_data.views.sodxtrmts_visualize'),
    ...
    (r'^swcke/apps/gridded/clim_sum_maps/(\?P<start_date>[\d{8,10}])(\&P<end_date>[\d{8,10})(\&P<element>[^,]+)(\&P<grid>[^,]+)(\&P<bounding_box>[^,]+)$', 'my_data.views.clim_sum_maps'),
     (r'^swcke/apps/gridded/area_time_series/$', 'my_data.views.area_time_series'),
    (r'^swcke/apps/gridded/area_time_series/(?P<start_date>[\d{8,10}])(\&P<end_date>[\d{8,10})(\&P<element>[^,]+)(\&P<grid>[^,]+)(\&P<state>[^,]+)$', 'my_data.views.area_time_series'),
    (r'^swcke/apps/gridded/area_time_series/(\?P<start_date>[\d{8,10}])(\&P<end_date>[\d{8,10})(\&P<element>[^,]+)(\&P<grid>[^,]+)(\&P<bounding_box>[^,]+)$', 'my_data.views.area_time_series'),
    (r'^swcke/apps/gridded/clim_prob_maps/$', 'my_data.views.clim_prob_maps'),
