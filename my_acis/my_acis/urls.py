...
urlpatterns = patterns('',
    ...
    (r'^scenic/data/multi/spatial_summary/$', 'scenic.views.ssummary'),
    (r'^scenic/data/multi/temporal_summary/$', 'scenic.views.tsummary'),
    (r'^scenic/data/multi/data_comparison/$', 'scenic.views.data_comparison'),
    (r'^scenic/data/area/$', 'scenic.views.area_prods'),
    (r'^scenic/data/area/lister/$', 'scenic.views.area_lister'),
    (r'^scenic/data/area/spatial_summary/$', 'scenic.views.ssummary'),
    (r'^scenic/data/area/temporal_summary/$', 'scenic.views.tsummary'),
