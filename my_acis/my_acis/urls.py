...
urlpatterns = patterns('',
    ...
    (r'^sw_ckn/main/about_us/$', 'my_data.views.about_us'),
    (r'^sw_ckn/main/contact_us/$', 'my_data.views.contact_us'),
    (r'^sw_ckn/main/who_we_are/$', 'my_data.views.who_we_are'),
    (r'^sw_ckn/main/what_we_do/$', 'my_data.views.what_we_do'),
    ...
    (r'^sw_ckn/data/modeled/(?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<bounding_box>[^,]+)$', 'my_data.views.data_modeled'),
    (r'^sw_ckn/data/modeled/(?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<state>[^,]+)$', 'my_data.views.data_modeled'),
    (r'^sw_ckn/data/modeled/(\?P<start_date>[\d{8,10}|por])(\&P<end_date>[\d{8,10}|por)(\&P<elements>[^,]+)(\&P<grid>[^,]+)(\&P<loc>[^,]+)$', 'my_data.views.data_modeled'),
