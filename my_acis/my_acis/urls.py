...
urlpatterns = patterns('',
    ...
    #(r'^scenic/data/single/monann/$', 'scenic.views.monann',{'app_type':'station'}),
    (r'^scenic/data/single/monann/$', 'scenic.views.monann'),
    (r'^scenic/data/single/climatology/$', 'scenic.views.climatology'),
    (r'^scenic/data/single/interannual/$', 'scenic.views.single_interannual'),
    (r'^scenic/data/single/intraannual/$', 'scenic.views.single_intraannual'),
    ...
    (r'^scenic/data/multi/climateengine/$', 'scenic.views.climateengine'),
