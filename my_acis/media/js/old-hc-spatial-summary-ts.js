    ...
    $(document).ready(function() {
        ...
        $.getJSON(json_file, function(datadict) {
            ...
            for (var el_idx=0;el_idx<element_list.length;el_idx++) {
                ...
                y_props = set_y_axis_properties(data_max,datadict.search_params.vertical_axis_max, data_min, datadict.search_params.vertical_axis_min, element_list[el_idx],'none','F',plotline_no)
