...
#needed for upload multiple files custom form field
...
class UploadFileForm(forms.Form):
    ...
    feature_id = forms.IntegerField(initial=0, required=True)
...
class AreaTimeSeriesForm1(forms.Form):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['vertical_axis_min'] = forms.CharField(required=False, initial='Use default', help_text='Set the y-axis minimum value.')
        self.fields['vertical_axis_max'] = forms.CharField(required=False, initial='Use default', help_text='Set the y-axis maximium value')
        '''
